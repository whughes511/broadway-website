...
(function() {
  ...
  pad_zero = function(num, length) {
    ...
    ret = "";
    for (i = k = 1, ref1 = length - ("" + num).length; 1 <= ref1 ? k <= ref1 : k >= ref1; i = 1 <= ref1 ? ++k : --k) {
      ret = ret.concat("0");
    }
  ...
  gCalFlow = (function() {
    gCalFlow.demo_apikey = 'AIzaSyCTDUW19n85z9fQXb7mElOFqFTPG3WhhJU';
